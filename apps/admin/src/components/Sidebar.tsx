...
export function Sidebar() {
  ...
  return (
    <aside className="fixed left-0 top-0 h-screen w-64 bg-surface-100 border-r border-surface-300 flex flex-col">
      {/* Logo */}
      <div className="p-6 border-b border-surface-300">
        <Link href="/dashboard" className="flex items-center gap-3">
          ...
          <div>
            <span className="font-semibold text-lg">Stashtab</span>
      ...
      <div className="p-4 border-t border-surface-300">
        <div className="flex items-center gap-3 px-4 py-2">
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-xs text-zinc-500 truncate">admin@stashtab.app</p>
          </div>
        </div>
      </div>
    </aside>
